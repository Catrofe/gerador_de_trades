...
class Menu:
    def __init__(self, ativos, repeticao, opcao_consulta, trade_consulta, valor_consulta):
        self.ativos = ativos
    ...
    def consultas(self):
        ...
        if self.opcao_consulta == None:
            ...
            db.retorna_trades_por_valor_maior_que_ativo(self.trade_consulta, self.valor_consulta)
        elif self.opcao_consulta == 4:
            db.retorna_trades_por_valor_menor_que(self.valor_consulta)
        elif self.opcao_consulta == 5:
            db.retorna_trades_por_valor_menor_que_ativo(self.trade_consulta, self.valor_consulta)
